...
object KafkaConfig {
  ...
  val aclAuthProp = "zookeeper.aclAuth"  
  val aclSchemaProp = "zookeeper.aclSchema"
  /** ********* General Configuration ***********/
  ...
  val aclAuthDoc = "Zookeeper acl auth string"
  val aclSchemaDoc = "Zookeeper acl schema string"
  /** ********* General Configuration ***********/
  ...
  private val configDef = {
    ...
    new ConfigDef()
      ...
      .define(aclAuthProp, STRING, Defaults.aclAuth, HIGH, aclAuthDoc)
      .define(aclSchemaProp, STRING, Defaults.aclSchema,  HIGH, aclSchemaDoc)
  ...
  def fromProps(props: Properties): KafkaConfig = {
    ...
    new KafkaConfig(
      ...
      aclAuth = parsed.get(aclAuthProp).asInstanceOf[String],
      aclSchema = parsed.get(aclSchemaProp).asInstanceOf[String],
...
class KafkaConfig(/** ********* Zookeeper Configuration ***********/
                  ...
                  val aclAuth: String = Defaults.aclAuth,
                  val aclSchema: String = Defaults.aclSchema,
  ...
  def toProps: Properties = {
    ...
    props.put(aclAuthProp, aclAuth)
    props.put(aclSchemaProp, aclSchema)
