...
class ConsumerTest extends IntegrationTestHarness with Logging {
  ...
  override def setUp() {
    ...
    TestUtils.createTopic(this.zkClient, topic, 1, serverCount, this.servers, acl=null)
  }
  ...
  def testPartitionsFor() {
    val numParts = 2
    TestUtils.createTopic(this.zkClient, "part-test", numParts, 1, this.servers, acl=null)
