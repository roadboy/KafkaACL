...
class ReplicaFetcherThread(name:String,
  ...
  def handleOffsetOutOfRange(topicAndPartition: TopicAndPartition): Long = {
     ...
     */
    val leaderEndOffset = simpleConsumer.earliestOrLatestOffset(topicAndPartition, OffsetRequest.LatestTime, brokerConfig.brokerId, brokerConfig.aclAuth, brokerConfig.zkConnect)
    if (leaderEndOffset < replica.logEndOffset.messageOffset) {
       ...
       */
      val leaderStartOffset = simpleConsumer.earliestOrLatestOffset(topicAndPartition, OffsetRequest.EarliestTime, brokerConfig.brokerId, brokerConfig.aclAuth, brokerConfig.zkConnect)
