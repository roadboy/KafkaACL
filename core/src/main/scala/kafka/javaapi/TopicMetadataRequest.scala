...
class TopicMetadataRequest(val versionId: Short,
  ...
  def this(topics: java.util.List[String], zkConnect: String) =
    this(kafka.api.TopicMetadataRequest.CurrentVersion, 0, kafka.api.TopicMetadataRequest.DefaultClientId, topics)
  
  def this(topics: java.util.List[String], aclAuth: String, zkConnect: String) =
    this(kafka.api.TopicMetadataRequest.CurrentVersion, 0, kafka.api.TopicMetadataRequest.DefaultClientId, topics )

  def this(topics: java.util.List[String], correlationId: Int, aclAuth: String, zkConnect: String) =
